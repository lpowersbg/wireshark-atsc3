...
proto_register_alp(void)
{
    static hf_register_info hf[] = {
        ...
        { &hf_alp_mpegts_numts, {
            ...
            FT_UINT8, BASE_DEC, NULL, ALP_MPEGTS_NUMTS_MASK, NULL, HFILL
        } },
        { &hf_alp_mpegts_ahf, {
        ...
        { &hf_alp_mpegts_dnp, {
            ...
            FT_UINT8, BASE_DEC, NULL, ALP_MPEGTS_DNP_MASK, NULL, HFILL
        } },
        ...
        { &hf_alp_header_extension_type, {
            "Header Extension Type", "alp.he_type",
