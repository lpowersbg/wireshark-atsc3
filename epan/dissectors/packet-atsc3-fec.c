...
void proto_register_atsc3_fec(void);
...
/* String tables */
const value_string string_atsc3_fec_encoding_id[] =
{
    {   0, "Compact No-Code" },
    {   1, "Raptor" },
...
void atsc3_fec_decode_ext_fti(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, guint8 encoding_id)
{
...
void proto_register_atsc3_fec(void)
{
    static hf_register_info hf[] = {
        { &hf_encoding_id,
          { "FEC Encoding ID", "rmt-fec.encoding_id",
            FT_UINT8, BASE_DEC, VALS(string_atsc3_fec_encoding_id), 0x0,
            NULL, HFILL }
        },
        { &hf_instance_id,
    ...
    proto_rmt_fec = proto_register_protocol("ATSC3 Forward Error Correction (FEC)", "ATSC3-FEC", "atsc3-fec");
    register_dissector("atsc3-fec", dissect_fec, proto_rmt_fec);
